...
TRAIN_CSV = '/kaggle/input/training-data/train.csv'
SUPPLE_TRAIN_CSV = '/kaggle/input/training-data/supplemental_train.csv'
ASSET_DETAILS_CSV = '/kaggle/input/training-data/asset_details.csv'
